...
Install方法としては、以下の手順で実施しました。
１．HomeAssiostansceに.Net実行環境を用意する
２．ビルド済みオブジェクトを対象となるHomeAssistanceに置く
３．credential.jsonを必要に応じて変更する
４．.Netが起動したら、自動的にオブジェクトが生成されるので待つ。
５．Entitiとして表示されることを確認する
